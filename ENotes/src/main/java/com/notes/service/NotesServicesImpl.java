...
public class NotesServicesImpl implements NotesService {
	...
	public boolean deleteNotes(int id) {
		...
		try {
			...
			// Delete file from S3
			if (notes.getFileName() != null) {
				s3Service.deleteFile(notes.getFileName());
			}
	...
	// private static final String BASE_DIRECTORY = "C:/Users/Harshal
	// PC/Desktop/.vscode/Spring Boot/Project/Major-Project/E-Notes/ENotes-Data";
	...
	// notesRepository.delete(notes);
	// try {
	// Path imagePath = Paths.get(BASE_DIRECTORY + "/" + notes.getUser().getEmail()
	// + "/" + notes.getFileName());
